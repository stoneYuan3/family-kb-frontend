            ...
            {editing && (
                <div className="mt-6">
                    ...
                    >
                        ...
                        <p className="text-sm text-muted-foreground">Click to add more documents</p>
                        <p className="text-xs text-muted-foreground/70">Photos, PDFs, or scanned documents</p>
                    </div>
                    <input
                        ref={fileInputRef}
                        type="file"
